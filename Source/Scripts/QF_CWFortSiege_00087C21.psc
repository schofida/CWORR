...
;CWO - Set CW quest objective to failed
if ((self as Quest) as CWFortSiegeScript).WasThisAnAttack
	kmyQuest.CWs.CWCampaignS.failCWObj(Alias_hold.getlocation())
endif
;CWO - Set Failed Mission in Campaign
...
;CWO Set CW Contested Hold Winner to the Dfender
kmyQuest.CWs.ContestedHoldWinner = kmyQuest.CWs.GetDefender(Alias_Fort.GetLocation())
...
elseif kmyQuest.CWs.CWCampaignS.PlayerAllegianceLastStand()
	kmyQuest.CWs.CWSiegeS.AttackersHaveWon = false
	kmyQuest.CWs.CWSiegeS.DefendersHaveWon = true
	(kmyQuest.CWs.CWFinale as CWFinaleScript).PlayerLastStandWasSuccessful()
else
...
;	((self as quest) as CWFortSiegeMissionScript).FlagFieldCOWithPotentialMissionFactions(50, ForceMissionNumber = 1) ;50 = Final Battle at Minor Capital (this quest type)
	...
	if !kmyQuest.IsPlayerAttacking() && JarlActor != none
		JarlActor.AddToFaction(kmyquest.cws.cwcampaigns.CWODefensiveFaction)
	endif
endif
...
;<TurnOnAliases>------------------
CWScript.Log("CWFortSiege", "Stage 10: TurnOnAliases()")		;*** WRITE TO LOG
...
if kmyQuest.IsPlayerAttacking()
	if Alias_Attacker1.GetActorReference().isinfaction(kmyQuest.CWs.CWCampaignS.CWSoldierPlayerEnemyFaction)
		Alias_Attacker1.GetActorReference().RemoveFromFaction(kmyQuest.CWs.CWCampaignS.CWSoldierPlayerEnemyFaction)
		Alias_Attacker2.GetActorReference().RemoveFromFaction(kmyQuest.CWs.CWCampaignS.CWSoldierPlayerEnemyFaction)
		Alias_Attacker3.GetActorReference().RemoveFromFaction(kmyQuest.CWs.CWCampaignS.CWSoldierPlayerEnemyFaction)
		Alias_Attacker4.GetActorReference().RemoveFromFaction(kmyQuest.CWs.CWCampaignS.CWSoldierPlayerEnemyFaction)
		Alias_Attacker5.GetActorReference().RemoveFromFaction(kmyQuest.CWs.CWCampaignS.CWSoldierPlayerEnemyFaction)
		Alias_Attacker6.GetActorReference().RemoveFromFaction(kmyQuest.CWs.CWCampaignS.CWSoldierPlayerEnemyFaction)
		Alias_Attacker7.GetActorReference().RemoveFromFaction(kmyQuest.CWs.CWCampaignS.CWSoldierPlayerEnemyFaction)
		Alias_Attacker8.GetActorReference().RemoveFromFaction(kmyQuest.CWs.CWCampaignS.CWSoldierPlayerEnemyFaction)
		Alias_Attacker9.GetActorReference().RemoveFromFaction(kmyQuest.CWs.CWCampaignS.CWSoldierPlayerEnemyFaction)
		Alias_Attacker10.GetActorReference().RemoveFromFaction(kmyQuest.CWs.CWCampaignS.CWSoldierPlayerEnemyFaction)
	endIf
elseIf Alias_Defender1.GetActorReference().isinfaction(kmyQuest.CWs.CWCampaignS.CWSoldierPlayerEnemyFaction)
	Alias_Defender1.GetActorReference().RemoveFromFaction(kmyQuest.CWs.CWCampaignS.CWSoldierPlayerEnemyFaction)
	Alias_Defender2.GetActorReference().RemoveFromFaction(kmyQuest.CWs.CWCampaignS.CWSoldierPlayerEnemyFaction)
	Alias_Defender3.GetActorReference().RemoveFromFaction(kmyQuest.CWs.CWCampaignS.CWSoldierPlayerEnemyFaction)
	Alias_Defender4.GetActorReference().RemoveFromFaction(kmyQuest.CWs.CWCampaignS.CWSoldierPlayerEnemyFaction)
	Alias_Defender5.GetActorReference().RemoveFromFaction(kmyQuest.CWs.CWCampaignS.CWSoldierPlayerEnemyFaction)
	Alias_Defender6.GetActorReference().RemoveFromFaction(kmyQuest.CWs.CWCampaignS.CWSoldierPlayerEnemyFaction)
	Alias_Defender7.GetActorReference().RemoveFromFaction(kmyQuest.CWs.CWCampaignS.CWSoldierPlayerEnemyFaction)
	Alias_Defender8.GetActorReference().RemoveFromFaction(kmyQuest.CWs.CWCampaignS.CWSoldierPlayerEnemyFaction)
	Alias_Defender9.GetActorReference().RemoveFromFaction(kmyQuest.CWs.CWCampaignS.CWSoldierPlayerEnemyFaction)
	Alias_Defender10.GetActorReference().RemoveFromFaction(kmyQuest.CWs.CWCampaignS.CWSoldierPlayerEnemyFaction)
endIf
...
if kmyQuest.CWs.CWCampaignS.PlayerAllegianceLastStand() && !kmyQuest.CWs.CWSiegeS.GetStageDone(200)
	kmyQuest.CWs.CWCampaignS.StartMonitors(kmyQuest)
	kmyQuest.CWs.CWCampaignS.StopDisguiseQuest()
	kmyQuest.CWs.CWCampaignS.StopCWOBAControllerQuest()
	if kmyQuest.CWs.CWSiegeS.GetStage() != 60
		kmyQuest.CWs.CWSiegeS.SetStage(60)
	endif
...
;EVP EVERYONE
Alias_Attacker1.TryToEnable()
Alias_Attacker1.TryToEvaluatePackage()
Alias_Attacker2.TryToEnable()
Alias_Attacker2.TryToEvaluatePackage()
Alias_Attacker3.TryToEnable()
Alias_Attacker3.TryToEvaluatePackage()
Alias_Attacker4.TryToEnable()
Alias_Attacker4.TryToEvaluatePackage()
Alias_Attacker5.TryToEnable()
Alias_Attacker5.TryToEvaluatePackage()
Alias_Attacker6.TryToEnable()
Alias_Attacker6.TryToEvaluatePackage()
Alias_Attacker7.TryToEnable()
Alias_Attacker7.TryToEvaluatePackage()
Alias_Attacker8.TryToEnable()
Alias_Attacker8.TryToEvaluatePackage()
Alias_Attacker9.TryToEnable()
Alias_Attacker9.TryToEvaluatePackage()
Alias_Attacker10.TryToEnable()
Alias_Attacker10.TryToEvaluatePackage()

Alias_Defender1.TryToEnable()
Alias_Defender1.TryToEvaluatePackage()
Alias_Defender2.TryToEnable()
Alias_Defender2.TryToEvaluatePackage()
Alias_Defender3.TryToEnable()
Alias_Defender3.TryToEvaluatePackage()
Alias_Defender4.TryToEnable()
Alias_Defender4.TryToEvaluatePackage()
Alias_Defender5.TryToEnable()
Alias_Defender5.TryToEvaluatePackage()
Alias_Defender6.TryToEnable()
Alias_Defender6.TryToEvaluatePackage()
Alias_Defender7.TryToEnable()
Alias_Defender7.TryToEvaluatePackage()
Alias_Defender8.TryToEnable()
Alias_Defender8.TryToEvaluatePackage()
Alias_Defender9.TryToEnable()
Alias_Defender9.TryToEvaluatePackage()
Alias_Defender10.TryToEnable()
Alias_Defender10.TryToEvaluatePackage()
;END CODE
EndFunction
;END FRAGMENT
...
kmyquest.StopCombatSoundsLoop()
kmyQuest.MUSCombatCivilWar.Remove()
;CWO Set attacker as hold winner (for finalizing routines)
kmyQuest.CWs.ContestedHoldWinner = kmyQuest.CWs.GetAttacker(Alias_Fort.GetLocation())
