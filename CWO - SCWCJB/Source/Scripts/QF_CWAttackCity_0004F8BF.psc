...
if Alias_City.GetLocation() == kmyquest.CWs.WhiterunLocation && kmyQuest.CWs.Playerallegiance == 1 ; schofida - assumed to be sons so added a check in case Imperials are reclaiming Whiterun
	Alias_BodyGuard1.ForceRefTo(ResolutionJarlGuardMarker1Ref.PlaceAtMe(kmyquest.CWSiegeWhiterunSonsSoldier))
	Alias_BodyGuard2.ForceRefTo(ResolutionJarlGuardMarker2Ref.PlaceAtMe(kmyquest.CWSiegeWhiterunSonsSoldier))
	Alias_BodyGuard3.ForceRefTo(ResolutionJarlGuardMarker3Ref.PlaceAtMe(kmyquest.CWSiegeWhiterunSonsSoldier))
	Alias_BodyGuard4.ForceRefTo(ResolutionJarlGuardMarker4Ref.PlaceAtMe(kmyquest.CWSiegeWhiterunSonsSoldier))
	Alias_BodyGuard5.ForceRefTo(ResolutionJarlGuardMarker5Ref.PlaceAtMe(kmyquest.CWSiegeWhiterunSonsSoldier))
	Alias_BodyGuard6.ForceRefTo(ResolutionJarlGuardMarker6Ref.PlaceAtMe(kmyquest.CWSiegeWhiterunSonsSoldier))
...
if  Alias_City.GetLocation() == kmyquest.CWs.WhiterunLocation 
	...
	if kmyQuest.CWs.PlayerAllegiance == 2
		...
		Alias_EnemySoldier1.ForceRefTo(ResolutionDefenderMarkerRef1.PlaceAtMe(kmyquest.CWSiegeWhiterunSonsSoldier))
		Alias_EnemySoldier2.ForceRefTo(ResolutionDefenderMarkerRef2.PlaceAtMe(kmyquest.CWSiegeWhiterunSonsSoldier))
		Alias_EnemySoldier3.ForceRefTo(ResolutionDefenderMarkerRef3.PlaceAtMe(kmyquest.CWSiegeWhiterunSonsSoldier))
		Alias_EnemySoldier4.ForceRefTo(ResolutionDefenderMarkerRef4.PlaceAtMe(kmyquest.CWSiegeWhiterunSonsSoldier))
		Alias_EnemySoldier5.ForceRefTo(ResolutionDefenderMarkerRef5.PlaceAtMe(kmyquest.CWSiegeWhiterunSonsSoldier))
		Alias_EnemySoldier6.ForceRefTo(ResolutionDefenderMarkerRef6.PlaceAtMe(kmyquest.CWSiegeWhiterunSonsSoldier))
		Alias_EnemySoldier7.ForceRefTo(ResolutionDefenderMarkerRef7.PlaceAtMe(kmyquest.CWSiegeWhiterunSonsSoldier))
		Alias_EnemySoldier8.ForceRefTo(ResolutionDefenderMarkerRef8.PlaceAtMe(kmyquest.CWSiegeWhiterunSonsSoldier))
		Alias_EnemySoldier9.ForceRefTo(ResolutionDefenderMarkerRef9.PlaceAtMe(kmyquest.CWSiegeWhiterunSonsSoldier))
		Alias_EnemySoldier10.ForceRefTo(ResolutionDefenderMarkerRef10.PlaceAtMe(kmyquest.CWSiegeWhiterunSonsSoldier))
		Alias_EnemySoldier11.ForceRefTo(ResolutionDefenderMarkerRef11.PlaceAtMe(kmyquest.CWSiegeWhiterunSonsSoldier))
		Alias_EnemySoldier12.ForceRefTo(ResolutionDefenderMarkerRef12.PlaceAtMe(kmyquest.CWSiegeWhiterunSonsSoldier))
	endif
...
kmyquest.CWSiegeObj.setObjectiveCompleted(1205)
